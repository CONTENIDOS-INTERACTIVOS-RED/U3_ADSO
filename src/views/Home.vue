        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los inicios del desarrollo de software moderno, la necesidad de crear aplicaciones modulares, escalables y fáciles de mantener ha llevado a la adopción de enfoques estructurados como el diseño orientado a objetos. En esta unidad, se estudian los principios SOLID, los patrones de diseño y el uso de diagramas UML como herramientas fundamentales para construir soluciones de software robustas, reutilizables y comprensibles. Se explorará cómo estos elementos permiten representar, analizar y optimizar la estructura y el comportamiento del sistema, asegurando un desarrollo más profesional y eficiente.
              
              p #[b ¡Prepárese para diseñar soluciones tecnológicas con calidad, claridad y sostenibilidad!]
